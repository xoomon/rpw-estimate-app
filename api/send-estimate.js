...
const {buildTextEmail, buildHtmlEmail, currency} = require('../lib/emailFormat');
...
module.exports = async (req, res) => {
  ...
  try{
    ...
    const {data, error} = await resend.emails.send({
      ...
      from: process.env.FROM_EMAIL || 'Raleigh Power Wash Estimates <estimates@raleighpowerwash.com>',
